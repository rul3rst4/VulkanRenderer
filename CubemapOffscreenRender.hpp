...
class CubemapOffscreenRender : public IRenderProcess {
   public:
    ...
    virtual ~CubemapOffscreenRender() = default;
    ...
    void createOffscreenPipeline() {
        auto vertShaderModule = vulkanCore.createShaderModule(vulkanCore.readShaderFile("shaders/offscreen_vert.spv"));
        auto fragShaderModule = vulkanCore.createShaderModule(vulkanCore.readShaderFile("shaders/offscreen_frag.spv"));
    ...
    void createOffscreenFramebuffers() {
        ...
        for (uint32_t i = 0; i < 6; ++i) {
            offscreenImageViews.emplace_back(vulkanCore.createImageView(textureImage, vk::Format::eR8G8B8A8Srgb,
