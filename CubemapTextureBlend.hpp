    ...
    constexpr static std::array<vk::VertexInputAttributeDescription, 2> getAttributeDescriptions() {
        constexpr std::array<vk::VertexInputAttributeDescription, 2> attributeDescriptions{{
            {.location = 0,
             ...
             .offset = offsetof(BlendVertex, pos)},
            {.location = 1,
             .binding = 0,
             .format = vk::Format::eR32G32Sfloat,
...
private:
    void createSwapChainImageViews() {
        ...
        for (const auto& swapChainImage : vulkanCore.swapChainImages) {
            swapChainImageViews.emplace_back(vulkanCore.createImageView(
                swapChainImage, vulkanCore.swapChainImageFormat, vk::ImageAspectFlagBits::eColor,
    ...
    void createCubemapImageView() {
        ...
        screenCubemapView = vulkanCore.createImageView(
            *sharedData->cubemapTexture, vk::Format::eR8G8B8A8Srgb,
    ...
    void createScreenRenderPass() {
        vk::AttachmentDescription colorAttachment{
            .format = vulkanCore.swapChainImageFormat,
    ...
    void renderFrame() {
        ...
        const auto result = vulkanCore.device.waitForFences(*vulkanCore.inFlightFences[vulkanCore.currentFrame], 
                                                           vk::True, UINT64_MAX);
        ...
        // Bind descriptor set
        commandBuffer.bindDescriptorSets(vk::PipelineBindPoint::eGraphics, *screenPipelineLayout,
